// HM Revenue & Customs exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/hmrc';
...
/** Latest rate for one pair, e.g. getRate('GBP', 'USD', { apiKey }). */
